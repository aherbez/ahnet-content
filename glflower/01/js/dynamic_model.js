class DynamicModel
{
    ...
    set rotationX(v){ this.rotation[0] = v; }
    set rotationY(v) { this.rotation[1] = v; }
    set rotationZ(v) { this.rotation[2] = v; }
    ...
    rotateX(v){ this.rotation[0] += v; }
    rotateY(v){ this.rotation[1] += v; }
    rotateZ(v){ this.rotation[2] += v; }
    ...
    initShaders()
    {
        ...
        this.fsShaderSource = `
            ...
            void main() {
                ...
                // gl_FragColor = vec4((1.0-vTextureCoord[0]) * 0.2, (1.0-vTextureCoord[0]) * 0.2, (1.0-vTextureCoord[0]) * 0.2, 1.0);
